...
<div class="container">
	<div class="row">
		<div class="col-md-10">
			...
			<h3><?php _e( 'System Info', $plugin_slug ); ?></h3>

			<p><?php _e( 'The following displays useful information about your website that may be requested from you for support reasons.', $plugin_slug ); ?></p>
